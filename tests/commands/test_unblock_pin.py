...
def test_unblock_pin_with_valid_str():
    card = Mock()
    puk = '123456789012'
    pin = '123456'
...
def test_unblock_pin_with_valid_bytes():
    card = Mock()
...
def test_unblock_pin_invalid_length(bad_input):
    card = Mock()
...
def test_unblock_pin_invalid_digits(bad_input):
    card = Mock()
